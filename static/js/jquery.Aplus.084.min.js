    ...
    $.fn.Aplus = function (options) {
        ...
        function parser(e) {
            ...
            if (a.hasClass('ajax')) {
                        ...
                        $.ajax({
                            ...
                            if (ajaxSett.from) {
                                ...
                                if (search.length) {
                                    ...
                                    lastVis.show();
                                    container.remove();
                                    a.trigger("ajaxMismatch.aplus", {
                                        response: data.html()
                                    })
                                }
                            } else container.html(data.html());
                            to.trigger("ajaxToComplete.aplus", {
                                obj: container
                            });
                            a.trigger("ajaxComplete.aplus", {
                                response: data.html()
                            })
                        }).fail(function (tS, eT) {
                            lastVis.show();
                            container.remove();
                            a.trigger("ajaxError.aplus", {
                                textStatus: tS,
                                errorThrown: eT
                            })
                        })
                ...
                $('html,body').animate({
                    scrollTop: $(url).offset().top + scroll.offsetY
                }, scroll.speed);
                return false
